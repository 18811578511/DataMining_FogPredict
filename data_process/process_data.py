    ...
    with open(read_dir, 'r', encoding='UTF-8') as inFile:
        with open(write_dir, "w", encoding='UTF-8') as outFile:
            for point in points:
                ...
                for line in inFile:
                    # 筛选正确的数据
                    if (len(line.split('	')) == 12) and ('2019' in line.split('	')[0]) and (len(line.split('	')[0]) == 19) and (point in line):
                        t = 0
...
points = ['北京万寿西宫', '北京东四', '北京天坛', '北京农展馆', '北京官园', '北京海淀区万柳', '北京顺义新城', '北京怀柔镇', '北京昌平镇', '北京奥体中心', '北京古城']
read_dir = 'C:/Users/xue/Desktop/毕设/数据/data_txt/beijing_data_before.txt'
write_dir = 'C:/Users/xue/Desktop/毕设/数据/data_txt/beijing_before_all.csv'
# delete_repetitive(read_dir,write_dir)
# find_city_data(points, read_dir, write_dir)
complete_data(read_dir, write_dir)
print('over')

# find_city_data(points, readDir, writeDir)
# a=['北京','1','2']
# a[2]=float(4.7)
# print(a)
